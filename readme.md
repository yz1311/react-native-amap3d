...
```bash
npm i @yz1311/react-native-amap3d
...
```jsx
import { MapView } from "@yz1311/react-native-amap3d";
```
...
参考 [examples](https://github.com/yz1311/react-native-amap3d/tree/master/example/examples)，或直接下载安装[示例 app](https://github.com/yz1311/react-native-amap3d/releases/download/v2.0.1/app-release.apk)。
...
[npm]: https://www.npmjs.com/package/@yz1311/react-native-amap3d
